...
public class RecipeDetailsActivity extends Activity {
	...
	@InjectView(R.id.activity_recipe_details_tv_description) TextView tvDescription;
	@InjectView(R.id.activity_recipe_details_tv_title) TextView tvTitle;
	@InjectView(R.id.activity_recipe_details_tv_subtitle) TextView tvSubtitle;
	@InjectView(R.id.activity_recipe_details_iv_image) ImageView ivImage;
